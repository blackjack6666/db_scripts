...
sns.barplot(data=df,x='sample types', y='average seq cov%',ax=ax,color='#fcf19a')
ax.tick_params(axis='x', which='minor', labelsize=10)
plt.xticks(rotation=90)
plt.savefig('F:/matrisomedb2.0/statistics/sample_top20_seq_cov_yellow.png',dpi=300,bbox_inches='tight')
# plt.show()